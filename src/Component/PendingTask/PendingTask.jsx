                                ...
                                <div className="header">
                                    ...
                                    <div className="task-action">
                                        <div className="dropdown  custom-dropdown">
                                            <a className="dropdown-toggle" href="/dada" style={{cursor:"pointer"}} role="button" id="pendingTask"
                                            ...
                                            <div className="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a className="dropdown-item" href="/dada" style={{cursor:"pointer"}}>Add</a>
                                                ...
                                                <a className="dropdown-item" href="/dada" style={{cursor:"pointer"}}>Clear All</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
