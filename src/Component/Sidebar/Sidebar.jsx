                ...
                <nav id="sidebar">
                    ...
                    <ul className="list-unstyled menu-categories" id="accordionExample">
                        <li className="menu active">
                            ...
                            <ul className="collapse submenu recent-submenu mini-recent-submenu list-unstyled show"
                        ...
                        <li className="menu">
                            ...
                            <ul className="collapse submenu list-unstyled" id="pages" data-parent="#accordionExample">
                                ...
                                <li>
                                    ...
                                    <ul className="collapse list-unstyled sub-submenu" id="pages-error"
                                        data-parent="#pages">
                                        <li>
                        ...
                        <li className="menu">
                            <a href="#authentication" data-toggle="collapse" aria-expanded="false"
                                className="dropdown-toggle">
                                <div className="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                            ...
                            <ul className="collapse submenu list-unstyled" id="authentication"
                                ...
                                <li>
                                    <a href="auth_pass_recovery_boxed.html">
                                        {" "}
                                        Recover ID Boxed{" "}
                                    </a>
                                </li>
